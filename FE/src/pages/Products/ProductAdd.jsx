                    ...
                    >
                        <Row>
                            <Col span={8}>
                                <Row>
                                    <Col span={20}>
                                        <Form.Item label="Kích thước" name="name" rules={[{ required: true, message: 'Vui lòng chọn kích thước !' }]}>
                                            <Select
                                                mode="multiple"
                                                allowClear
                                                style={{
                            ...
                            <Col span={8}>
                                <Row>
                                    <Col span={20}>
                                        <Form.Item label="Chất liệu:" name="name" rules={[{ required: true, message: 'Vui lòng chọn chất liệu !' }]} >
                                            <Select
                                                showSearch
                                                mode="multiple"
                                                style={{
